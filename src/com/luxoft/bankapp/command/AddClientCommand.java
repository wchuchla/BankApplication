...
public class AddClientCommand implements Command {
	...
	public void execute() {
		...
		} catch (ClientExistsException | DAOException e) {
			System.out.println(e.getMessage());
		}
	}

	private String nameRequest(Scanner scanner) {
		System.out.println("Enter your full name (e.g. John Mayer): ");
	...
	private String emailRequest(Scanner scanner) {
		System.out.println("Enter your email (e.g. jmayer@gmail.com): ");
	...
	private String phoneNumberRequest(Scanner scanner) {
		System.out.println("Enter your phone number (e.g. +001-123-456-789): ");
	...
	private String cityRequest(Scanner scanner) {
		System.out.println("Enter your city (e.g. New York): ");
	...
	private String initialOverdraftRequest(Scanner scanner) {
		System.out.println("Enter your initial overdraft (e.g. 10000): ");
